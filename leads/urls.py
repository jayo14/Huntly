...
urlpatterns = [
    ...
    path('scraper/session/<int:pk>/', views.scraper_session_detail, name='scraper-session-detail'),
    path('scraper/jobs/create/', views.scraper_create, name='scraper-create'),
    path('scraper/jobs/<int:pk>/terminate/', views.scraper_terminate, name='scraper-terminate'),
